...
def readdata():
    ...
    # Data Aquisition over full Range
...
while 1:
    ...
    for step in range(steps):
        ...
        if data < 20:
            continue
        deg = step/factor
        y = 255 + int((data/scale) * math.cos(deg * (3.14159 / 180)))
        x = 255 + int((data/scale) * math.sin(deg * (3.14159 / 180)))
        #pygame.draw.line(scanner_surface, (250, 250, 250), (250, 250), (x, y), 1)
